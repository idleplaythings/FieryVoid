var ShipGrid = function ShipGrid(ship, target, dispatcher)
{
    ShipDisplay.call(this, ship, target, "shipGrid", dispatcher);
...
ShipGrid.prototype = Object.create(ShipDisplay.prototype);

ShipGrid.prototype.drawImage = function()
{
