describe("Ship movement", function() {
     ...
     var moment = movement.getThrustMoment(getModule( {x:1, y:0}), {x:0, y:0})
     ...
     it("Thrust moment, thrustinc directly towards mass center on x", function() {
     ...
     var moment = movement.getThrustMoment(getModule({x:0, y:1}), {x:0, y:0})
