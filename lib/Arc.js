model.Arc = function Arc(center, radius, angle1, angle2)
{
    ...
    var point1 = MathLib.getPointInDirection(radius, angle1, center.x, center.y);
    var point2 = MathLib.getPointInDirection(radius, angle2, center.x, center.y);
