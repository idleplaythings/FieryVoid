...
model.Particle.prototype.isActive = function(size)
{
    return this.alive;
};

model.Particle.prototype.setSize = function(size)
{
    this.size = size;
    return this;
};

model.Particle.prototype.setColor = function(color)
{
    this.color = color;
    return this;
};
...
model.Particle.prototype.deactivate = function()
{
    this.alive = 0;
    return this;
};
